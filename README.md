...
*According to BilgiPasa's tests when tested in C# with random input. (If you compare the sorting algorithms' speed in different languages, you might get a different result. For example, when I (BilgiPasa) tested with Java, Selection Sort was faster than Insertsion Sort. But in C, C# and Python, Insertsion Sort was faster than Selection Sort.)
