...
I didn't copy-pasted any code from any AI (like ChatGPT, Deepseek, Claude) or websites. I wrote them myself. (But of course I get insprations from websites (for example geeksforgeeks) and videos (for example Bro Code and udiprod channels' videos). Also, I don't like using AI.)
