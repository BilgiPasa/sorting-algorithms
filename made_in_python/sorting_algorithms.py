...
class SortingAlgorithms:
    ...
    def quick_sort(num_arr, start: int, end: int) -> None:
        ...
        pivot: int = SortingAlgorithms.move_elements_and_return_pivot(num_arr, start, end)
        SortingAlgorithms.quick_sort(num_arr, start, pivot - 1)
        SortingAlgorithms.quick_sort(num_arr, pivot + 1, end)
    ...
    def merge_sort(num_arr) -> None:
        ...
        SortingAlgorithms.merge_sort(left_arr)
        SortingAlgorithms.merge_sort(right_arr)
        SortingAlgorithms.merge(num_arr, left_arr, right_arr)
    ...
    def selection_sort(num_arr) -> None:
        ...
        for i in range(length_minus_one):
            j = SortingAlgorithms.index_of_min(num_arr, len(num_arr), i)
            num_arr[i], num_arr[j] = num_arr[j], num_arr[i] # Swapping elements
    ...
    def sootage_sort(num_arr, start: int, end: int) -> None:
        ...
        if end - start > 1: # This means if array size > 2
            ...
            SortingAlgorithms.sootage_sort(num_arr, start, end - one_third)
            SortingAlgorithms.sootage_sort(num_arr, start + one_third, end)
            SortingAlgorithms.sootage_sort(num_arr, start, end - one_third)
    ...
    def bozo_sort(num_arr) -> None:
        ...
        while not SortingAlgorithms.is_sorted(num_arr):
